...
flags.DEFINE_string(
    "output_dir", os.path.join(output,'model_zalo_squad'),
    "The output directory where the model checkpoints will be written.")

## Other parameters
flags.DEFINE_string("train_file", os.path.join(base,'data/train-v2.0.json'),
                    "SQuAD json for training. E.g., train-v1.1.json")

flags.DEFINE_string(
    "predict_file", os.path.join(base,'data/dev-v2.0.json'),
